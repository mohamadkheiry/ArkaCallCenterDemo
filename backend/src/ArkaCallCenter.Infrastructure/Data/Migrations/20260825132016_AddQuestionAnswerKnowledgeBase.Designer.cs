...
namespace ArkaCallCenter.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260825132016_AddQuestionAnswerKnowledgeBase")]
    partial class AddQuestionAnswerKnowledgeBase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArkaCallCenter.Core.Entities.BaleChannelPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PhoneNumber", "Stage")
                        .IsUnique();

                    b.ToTable("BaleChannelPosts");
                });
            ...
            modelBuilder.Entity("ArkaCallCenter.Core.Entities.CallSession", b =>
                {
                    ...
                    b.Property<string>("UnansweredQuestionsJson")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("ArkaCallCenter.Core.Entities.CrmLeadSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArkaCallCenter.Core.Entities.SmartPhone", b =>
                {
                    ...
                    b.Property<int>("AnswerAccuracyPercent")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArkaCallCenter.Core.Entities.TokenUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArkaCallCenter.Core.Entities.VoiceOption", b =>
                {
                    ...
                    b.Property<string>("SampleAudioPath")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)");
