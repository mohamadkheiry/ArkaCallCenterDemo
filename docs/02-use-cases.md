...
- **جریان:** پخش پیام خوش‌آمد → دریافت گفتار → پاسخ مستقیم به گفت‌وگوی اجتماعی، یا جست‌وجوی Hybrid RAG. پاسخ دانشی فقط با شاهد صریح پخش می‌شود؛ سؤال مرتبطِ بی‌پاسخ ارجاع و ثبت می‌گردد؛ سؤال خارج از حوزه فقط محدودهٔ خدمات را معرفی می‌کند و unanswered محسوب نمی‌شود.
