...
**بازه‌ی داخلی‌ها:** کاربران `۱۰۰۰–۹۹۹۹` (تخصیص خودکار در `ExtensionAllocator`) · دموها `۱–۹۹۹` با انتخاب دستی سوپرادمین؛ بازهٔ `۱۰۰–۳۰۰` برای تلفن‌های انسانی رزرو و غیرقابل انتخاب است.
...
| دموها با داخلی انتخابی ۱–۹۹۹ (به‌جز ۱۰۰–۳۰۰) | `DemoService` |
