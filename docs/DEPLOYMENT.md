...
2. در **پنل سوپرادمین → OpenAI و پاسخ دانشی**: `Base URL`، `API Key` و مدل Chat پاسخ مستقیم را وارد کنید.
3. در **پنل سوپرادمین → SMS.ir**: کلید و شماره خط را وارد کنید.
4. در **پنل سوپرادمین → CRM فروش**: `enabled`، Base URL، نام کاربری، رمز و دامنه ایمیل جایگزین را تنظیم کنید. رمز در Git قرار نمی‌گیرد.
5. در **پیام پیش‌فرض**: متن fallback را ذخیره و صوت آن را تولید کنید.
