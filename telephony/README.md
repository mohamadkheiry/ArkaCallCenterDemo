...
شماره‌های ثابت هشت‌رقمی تهران و داخلی‌های سه‌رقمی بلافاصله ارسال می‌شوند و سایر
شماره‌ها پس از ۵ ثانیه ارسال خواهند شد. پس از تغییر، گوشی باید واقعاً reboot
